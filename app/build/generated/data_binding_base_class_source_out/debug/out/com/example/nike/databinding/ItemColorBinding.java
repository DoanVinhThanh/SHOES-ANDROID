...
public final class ItemColorBinding implements ViewBinding {
  ...
  private ItemColorBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgColor,
      @NonNull TextView tvColorName) {
  ...
  public static ItemColorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.imgColor;
      ImageView imgColor = ViewBindings.findChildViewById(rootView, id);
      if (imgColor == null) {
        break missingId;
      }
      ...
      return new ItemColorBinding((LinearLayout) rootView, imgColor, tvColorName);
    }
