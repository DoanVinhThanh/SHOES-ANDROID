...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageCategory) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.image_category;
      ImageView imageCategory = ViewBindings.findChildViewById(rootView, id);
      if (imageCategory == null) {
        break missingId;
      }

      return new ItemCategoryBinding((LinearLayout) rootView, imageCategory);
    }
